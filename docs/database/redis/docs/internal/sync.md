---
description: 'Redis SYNC命令是复制功能的内部命令，时间复杂度O(N)，用于序列化数据以支持主从同步。'
lastUpdated: '2026-06-21 21:32:06'
head:
  - - meta
    - name: 'og:title'
      content: 'SYNC'
  ...
  - - meta
    - name: 'og:description'
      content: 'Redis SYNC命令是复制功能的内部命令，时间复杂度O(N)，用于序列化数据以支持主从同步。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//database/redis/docs/internal/sync.html'
---
# SYNC
