---
description: '根据给定SHA1校验和，检查脚本是否在Redis缓存中。返回与输入对应的0/1列表：0表示脚本不存在，1表示存在。时间复杂度O(N)。'
lastUpdated: '2026-06-21 21:34:07'
head:
  - - meta
    - name: 'og:title'
      content: 'SCRIPT EXISTS sha1 [sha1 …]'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: '根据给定SHA1校验和，检查脚本是否在Redis缓存中。返回与输入对应的0/1列表：0表示脚本不存在，1表示存在。时间复杂度O(N)。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//database/redis/docs/script/script_exists.html'
---
