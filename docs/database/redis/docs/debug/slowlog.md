---
description: 'Redis的SLOWLOG命令用于管理慢查询日志，通过设置slowlog-log-slower-than参数定义慢查询阈值（如10微秒），可查看当前日志数量及详细记录，并支持清空所有慢日志。'
lastUpdated: '2026-06-21 21:30:49'
head:
  - - meta
    - name: 'og:title'
      content: 'SLOWLOG subcommand [argument]'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: 'Redis的SLOWLOG命令用于管理慢查询日志，通过设置slowlog-log-slower-than参数定义慢查询阈值（如10微秒），可查看当前日志数量及详细记录，并支持清空所有慢日志。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//database/redis/docs/debug/slowlog.html'
---
