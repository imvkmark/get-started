---
description: 'Redis INFO命令以易解析格式返回服务器统计信息，支持通过section参数筛选，如server部分包含版本、Git信息、操作系统、架构、事件机制、GCC版本、PID、随机标识、端口、运行时间等，可指定特定领域。'
lastUpdated: '2026-06-21 21:29:10'
head:
  - - meta
    - name: 'og:title'
  ...
  - - meta
    - name: 'og:description'
      content: 'Redis INFO命令以易解析格式返回服务器统计信息，支持通过section参数筛选，如server部分包含版本、Git信息、操作系统、架构、事件机制、GCC版本、PID、随机标识、端口、运行时间等，可指定特定领域。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//database/redis/docs/client_and_server/info.html'
---
# INFO [section]
