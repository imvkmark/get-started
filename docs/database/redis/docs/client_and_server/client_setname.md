---
description: 'CLIENT SETNAME 命令用于为当前连接设置一个名字，新连接默认无名字。设置后返回名字，可在客户端列表中查看。通过设置空字符串可清除名字。'
lastUpdated: '2026-06-21 21:29:09'
head:
  - - meta
    - name: 'og:title'
      content: 'CLIENT SETNAME connection-name'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: 'CLIENT SETNAME 命令用于为当前连接设置一个名字，新连接默认无名字。设置后返回名字，可在客户端列表中查看。通过设置空字符串可清除名字。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//database/redis/docs/client_and_server/client_setname.html'
---
