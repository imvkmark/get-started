...
![](https://file.wulicode.com/feishu-images/2d6b09bb65fac3bd23369b814fa68d94.png)
...
![](https://file.wulicode.com/feishu-images/0f154b9f1a9f7ad5a710afb3cb289863.png)
...
![](https://file.wulicode.com/feishu-images/7b5d6ac25145b914bd8eac3cb22e019b.png)
...
![](https://file.wulicode.com/feishu-images/ece76768f252c36f61d6ce40ae6a6c38.png)
...
![](https://file.wulicode.com/feishu-images/665c4d98c4a058f0fcddaa7bf9755206.png)
...
![](https://file.wulicode.com/feishu-images/f684db54a02c19186d1acda07713b7d9.png)

```Plaintext
对每一个key进行hash运算，被哈希后的结果在哪个token的范围内，则按顺时针去找最近的节点，这个key将会被保存在这个节点上。
```

![](https://file.wulicode.com/feishu-images/2f2fefb1f42854377575b3f41d051cd1.png)

![](https://file.wulicode.com/feishu-images/8819f50c0601f00d0f4e6cb41d66b199.png)
...
![](https://file.wulicode.com/feishu-images/6c5937a003b559129a67ad28d1d70d85.png)
...
虚拟槽分布方式中，由于每个节点管理一部分数据槽，数据保存到数据槽中。当节点扩容或者缩容时，对数据槽进行重新分配迁移即可，数据不会丢失。虚拟槽分区特点：
...
![](https://file.wulicode.com/feishu-images/835475275599e82d90dcd9fceca27ca8.png)
...
![](https://file.wulicode.com/feishu-images/5399c27a0725ef7c9545f21196909cff.png)
...
![](https://file.wulicode.com/feishu-images/4cca3e9a5c9e167cfd81f7cad0923c75.png)
...
![](https://file.wulicode.com/feishu-images/0a1198124307bdd0de44bbcc7388b004.png)

![](https://file.wulicode.com/feishu-images/a4c28939649e4828137620a63bc1732d.png)
...
![](https://file.wulicode.com/feishu-images/0de98dcc57f5bf0dfa1bfb3a3013ee2e.png)

需要注意的是：客户端不会自动找到目标节点执行命令

槽命中：直接返回

![](https://file.wulicode.com/feishu-images/0615a24f24e1ac8c7386ea73cf821986.png)
...
![](https://file.wulicode.com/feishu-images/540e9db894afec5b5b3d28d8e494a040.png)
...
![](https://file.wulicode.com/feishu-images/718652f5c4dcd5d78767092fba026a4f.png)
...
![](https://file.wulicode.com/feishu-images/0189ce570678791eeabd2898c9f51da4.png)
...
![](https://file.wulicode.com/feishu-images/0f6144a9f32b1929c5352ba1a2f04880.png)
...
![](https://file.wulicode.com/feishu-images/57ef3795224a804e29e41c914d242ddd.png)
...
![](https://file.wulicode.com/feishu-images/a01d6c57c7b1a56e0434a287a207ce39.png)

### 3.6.3 并行IO

并行IO是对串行IO的一个优化，把key分组之后，根据节点数量启动对应的线程数，根据多线程模式并行向node节点请求数据，只需要1次网络时间

![](https://file.wulicode.com/feishu-images/ae91051f69828321886c1d7711687870.png)

### 3.6.4 hash_tag

将key进行hash_tag的包装，然后把tag用大括号括起来，保证所有的key只向一个node请求数据，这样执行类似mget命令只需要去一个节点获取数据即可，效率更高

![](https://file.wulicode.com/feishu-images/1f96b38f1435cb64c95684d266d60bb8.png)

### 3.6.5 四种优化方案优缺点分析

![](https://file.wulicode.com/feishu-images/cb7bc0fa683f72a62df620b265b857a2.png)
...
![](https://file.wulicode.com/feishu-images/bc9665f8be2ff2972ad643fc3d9fc5c7.png)
...
![](https://file.wulicode.com/feishu-images/38a88ad2d4a9945764a517746d70af9b.png)

![](https://file.wulicode.com/feishu-images/94bb512dcb58458108ce5b4d36d385f3.png)
...
![](https://file.wulicode.com/feishu-images/41f86081c9e208b4acae3661a56b7fc8.png)
...
![](https://file.wulicode.com/feishu-images/764c539e5ce52f804517a875d9b375bf.png)
...
- 2.[官方工具安装](https://www.cnblogs.com/renpingsheng/p/9833740.html)5.开发运维常见的问题5.1 集群完整性
