...
哈希类型也是key-value结构，key是字符串类型，其value分为两个部分:field和value 其中field部分代表属性，value代表属性对应的值

![](https://file.wulicode.com/feishu-images/623f8fee105599bf083c1ced5b118522.png)
...
记录网站每个用户个人主页的访问量，也可以使用哈希类型 这样可以保证每个用户的相关数据是一个整体，而使用字符串类型保存的话，则每个用户个人主面的访问量与每个用户的其他数据都是一个分离的状态。
...
![](https://file.wulicode.com/feishu-images/452e1b55e87de6481de53838126fa7a1.png)
...
![](https://file.wulicode.com/feishu-images/a931fed170ae5f9de449d4da5213b89e.png)
...
![](https://file.wulicode.com/feishu-images/cbf5a360d93320d70885503c9bb977a2.png)

对用户的属性进行查询，更新和添加都比较方便

保存用户相关数据的方式比较

![](https://file.wulicode.com/feishu-images/b826e54e9de59a922acdab3140ac7ebf.png)