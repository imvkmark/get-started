...
![](https://file.wulicode.com/feishu-images/83e956a2b2badb14e558b5cabb6af4f6.png)
...
![](https://file.wulicode.com/feishu-images/907f6b4ec2f964861e1a0f3123a75ac6.png)

### 2.3 读写分离模型

master节点负责写数据，同时客户端可以从slave节点读取数据

![](https://file.wulicode.com/feishu-images/c2db53a58c5599cccd02f226e57534d0.png)
...
![](https://file.wulicode.com/feishu-images/eb7f29149f0578a9f30451ce90531e25.png)

取消复制

![](https://file.wulicode.com/feishu-images/aabf7403c13ea6c17c5cb13b45f7ee10.png)
...
![](https://file.wulicode.com/feishu-images/5b0706e195b6308062ced5a1a95a7cd8.png)
...
master接收到slave传输的偏移量，会与repl_back_buffer复制缓冲区中的offset做对比，如果接收到的offset小于repl_back_buffer中记录的偏移量，master就会把两个偏移量之间的数据发送给slave，slave同步完成，slave中的数据就与master中的数据一致

如下图所示

![](https://file.wulicode.com/feishu-images/447e2ff28a66afc6fd34828102844672.png)

## 6. 主从复制故障

### 6.1 slave宕机

![](https://file.wulicode.com/feishu-images/61ae135ecb4d8ede4d573c00763f3e48.png)

这种架构读写分离情况下，宕机的slave无法从master中同步数据

### 6.2 master宕机

![](https://file.wulicode.com/feishu-images/eb616bd08655ddbb2107254d4d3c101f.png)
...
![](https://file.wulicode.com/feishu-images/0d191b88f794b8ef0ce9665d43462394.png)
...
![](https://file.wulicode.com/feishu-images/b9f561aae3315874dc7fe30952ab48db.png)
...
![](https://file.wulicode.com/feishu-images/af7e004947337252841532226e00fc83.png)

单机多部署复制风暴

![](https://file.wulicode.com/feishu-images/ac8313b4c8b1c88fb293d567b2ff8aeb.png)
