...
![](https://file.wulicode.com/feishu-images/0b325dd6c787fcfdd4960cb30f0c15f4.png)
...
![](https://file.wulicode.com/feishu-images/029ff95467769af05a114f03c6dd2b5c.png)
...
![](https://file.wulicode.com/feishu-images/86357904b5d883a54957c80808f31cf9.png)
...
![](https://file.wulicode.com/feishu-images/489d7381104a4fccc47ffa6e35af3e5f.png)

正常情况下，客户端从缓存中获取数据，如果缓存中没有用户请求需要的数据，就会读取数据源中的数据返回给客户端，同时把数据回写到缓存中。这样当下次客户端再请求这个数据时，就可以直接从缓存中获取数据而不需要经过数据库了。

![](https://file.wulicode.com/feishu-images/9699de39f088608e06320d081473632b.png)
...
![](https://file.wulicode.com/feishu-images/aaddd6dfd583bd1d7e0ce691730614a4.png)
...
![](https://file.wulicode.com/feishu-images/9608e2c93738a969a9da0162e287b6ad.png)
...
![](https://file.wulicode.com/feishu-images/a9bd97565a94d895330e5af50ac0da42.png)
...
- 降低接入成本：例如客户端长连接/连接池，NIO等5.4 四种批量优化方法：5.4.1 串行mget

串行mget需要n次网络时间

![](https://file.wulicode.com/feishu-images/f9a5057885f5cf546bb9be93b02ed415.png)

### 5.4.2 串行IO

由于客户端对key进行重新组装，所以把网络通信时间降低到节点次O(node)

![](https://file.wulicode.com/feishu-images/046d187f998b84b7abe9ebab4075a486.png)

### 5.4.3 并行IO

并行IO也会在客户端对key进行重新组装，然后执行并行操作，所需要的网络时间为O(1)

![](https://file.wulicode.com/feishu-images/e5725380787cc91def86c9198d1742de.png)

### 5.4.4 hash_tag

hash_tag会把所有的key都分配到一个节点，但是使用这种方法会遇到各种问题

![](https://file.wulicode.com/feishu-images/456ef2a196aa04c501fc7a697a311e49.png)

### 5.5 四种优化方案的优缺点分析

![](https://file.wulicode.com/feishu-images/418bc30275cb615ef0159f466ab87e69.png)
...
![](https://file.wulicode.com/feishu-images/5f4ea6dd8de2afca93ce5e95936064aa.png)
...
![](https://file.wulicode.com/feishu-images/567add589957684a0234e6c407a55c71.png)
...
![](https://file.wulicode.com/feishu-images/941657a0d4b875f01c8e947e55c6b954.png)

### 6.4 缓存重建解决方法对比

![](https://file.wulicode.com/feishu-images/0a4d8bb2f7d3098320fd5d1626ac92e2.png)