...
lastUpdated: '2026-07-06 23:55:58'
head:
  - - meta
    - name: 'og:title'
...
安装完成后，在 Claude Code 中运行 `/omc-setup`（或带命名空间 `/oh-my-claudecode:omc-setup`），如果回显中包含 OMC 的版本号、Agent 数（19）、Skill 数（39），说明安装成功
