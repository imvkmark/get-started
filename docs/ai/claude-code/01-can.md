...
lastUpdated: '2026-07-07 13:45:24'
head:
  - - meta
    - name: 'og:title'
...
Claude Code 底层是语言模型，所有"理解"都发生在一个有限的**上下文窗口**里。目前 Claude Sonnet 5 支持最高 1M token 的上下文，听起来很大，但一个中等规模的 Spring Boot 项目轻松就有几十万行代码，全部塞进去既不现实也没必要。
