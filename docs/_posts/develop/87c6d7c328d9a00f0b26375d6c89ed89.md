...
一般来说，日常使用只要记住下图6个命令即可。但是熟练使用，恐怕要记住60～100个命令。<br />![](https://file.wulicode.com/yuque/202208/04/22/39416siZjiQ1.png?x-oss-process=image/resize,h_340)<br />下面是我整理的常用 Git 命令清单。几个专用名词的译名如下。
> - Workspace：工作区
