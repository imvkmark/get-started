...
客户端 Upgrade-Insecure-Requests 的内容,<br />表示客户端优先选择加密及带有身份验证的响应 [Upgrade-Insecure-Requests(MDN)](https://developer.mozilla.org/zh-CN/docs/Web/HTTP/Headers/Upgrade-Insecure-Requests)
