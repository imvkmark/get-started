---
description: '本文详细解析Python项目分发打包的完整流程，涵盖distutils与setuptools工具、easy_install使用、源码包与二进制包区别、eggs与wheels格式差异、setup.py编写技巧、辅助工具PBR，以及包的构建、安装和发布到PyPi的方法。'
lastUpdated: '2026-06-17 23:46:02'
head:
  - - meta
    - name: 'og:title'
      content: '[转]  Python 的 setup.py 介绍'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: '本文详细解析Python项目分发打包的完整流程，涵盖distutils与setuptools工具、easy_install使用、源码包与二进制包区别、eggs与wheels格式差异、setup.py编写技巧、辅助工具PBR，以及包的构建、安装和发布到PyPi的方法。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//back-end/python/extend-reading/setup-py.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/f404924a78111f3382910814b857275f.png'
---
# [转]  Python 的 setup.py 介绍

::: info 🔗
原文地址 : [花了两天，终于把 Python 的 setup.py 给整明白了 - 知乎](https://zhuanlan.zhihu.com/p/276461821)
:::
...
以上仅介绍了 easy_install 的一些常用的方法，想要了解更多，你可以点击官方文档：https://setuptools.pypa.io/en/latest/
...
![](https://file.wulicode.com/feishu-images/f404924a78111f3382910814b857275f.png)
...
![](https://file.wulicode.com/feishu-images/4927bfcbf9870f91c4f7db38647046d2.png)
...
![](https://file.wulicode.com/feishu-images/19281dbd26b448220cdec57e9b39de50.png)
...
![](https://file.wulicode.com/feishu-images/e106e6f75d735c03d6111006f9ff50da.png)
...
或者也可以使用 `twine` 工具注册上传，它是一个专门用于与 pypi 进行交互的工具，详情可以参考官网：[https://twine.readthedocs.io/en/stable/](https://twine.readthedocs.io/en/stable/) 这里不详细讲了