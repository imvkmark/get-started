...
head:
  ...
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/5bbb84791fcd90ec8b2c09e023f9f764.png'
---
# 配置 PyCharm 作为趁手的IDE
...
![](https://file.wulicode.com/feishu-images/5bbb84791fcd90ec8b2c09e023f9f764.png)

## 启用 ruff

位置 : `Settings | Python | Tools | Ruff`

![](https://file.wulicode.com/feishu-images/57a4be89f9164c83ebd284fe01093412.png)