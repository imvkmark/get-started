---
description: 'PHP的cURL扩展基于libcurl库，支持HTTP、HTTPS、FTP等协议，可实现HTTPS认证、POST/PUT请求、FTP上传、表单上传、代理、cookies及用户名密码认证。相关函数包括curl_close、curl_copy_handle、curl_errno等。'
lastUpdated: '2026-06-17 19:00:54'
head:
  - - meta
    - name: 'og:title'
      content: '其它服务 - cURL '
