---
description: 'YAML数据序列化扩展基于libYAML库，性能优于纯PHP方案。支持配置解码二进制、时间戳、输出规范、缩进与行宽，并提供yamlemitfile函数用于输出YAML到文件。'
lastUpdated: '2026-06-17 19:00:50'
head:
  - - meta
    - name: 'og:title'
      content: '其他基本扩展 - YAML Data Serialization'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
