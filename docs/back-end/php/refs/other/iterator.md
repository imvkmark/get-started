---
description: 'ArrayIterator是PHP SPL迭代器，允许在遍历数组或对象时修改键/值。它实现ArrayAccess、SeekableIterator、Countable和Serializable接口，提供append、asort、count、current等方法。需通过ArrayObject创建实例以实现多次遍历。'
lastUpdated: '2026-06-17 18:01:57'
head:
  - - meta
    - name: 'og:title'
      content: 'SPL - Iterators(迭代器) '
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
