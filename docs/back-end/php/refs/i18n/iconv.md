---
description: '本文介绍了国际化与字符编码支持中iconv的安装、配置及常用函数，帮助用户处理字符集转换。'
lastUpdated: '2026-06-17 19:02:14'
head:
  - - meta
    - name: 'og:title'
      content: '国际化与字符编码支持 - iconv'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
...
设置配置的值. - $typeinput_encoding output_encoding internal_encoding - $character 设置的字符
