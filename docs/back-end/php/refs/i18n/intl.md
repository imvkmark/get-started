---
description: '该内容为PHP Intl扩展的待完成功能列表，涵盖国际化与字符编码支持，包括Collator、NumberFormatter、Locale、Normalizer等核心组件，以及MessageFormatter、IntlCalendar、IntlTimeZone等高级功能，均标记为WIP（工作进展中）。'
lastUpdated: '2026-06-17 19:02:18'
head:
  - - meta
    - name: 'og:title'
      content: '[WIP]国际化与字符编码支持 - Intl'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
