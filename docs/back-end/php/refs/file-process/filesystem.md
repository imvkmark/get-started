---
description: '文件系统扩展用于操作文件和目录，提供配置选项（如编码、权限）及函数（如读取、写入、删除文件，遍历目录等），支持路径处理、文件信息获取，常用于服务器端资源管理。'
lastUpdated: '2026-06-17 18:05:52'
head:
  - - meta
    - name: 'og:title'
      content: 'Filesystem'
...
![](https://file.wulicode.com/feishu-images/19a8684eeeb42657a0521832701a97aa.png)
...
![](https://file.wulicode.com/feishu-images/8818f9407318b85cfa6ae0b63b3b112a.png)
...
![](https://file.wulicode.com/feishu-images/d568297cab0427b582bbbd13052929bf.png)
