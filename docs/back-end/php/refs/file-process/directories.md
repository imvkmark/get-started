---
description: '文件系统扩展提供了目录相关的常量与函数，用于创建、删除、遍历和操作目录。常见函数如mkdir、rmdir、opendir、readdir等，以及路径分隔符等常量，便于跨平台目录管理。'
lastUpdated: '2026-06-17 18:05:41'
head:
  - - meta
    - name: 'og:title'
      content: 'Directories'
...
获取当前的工作目录, 可以使用这个函数来替代\_\_FILE\_\_获取当前工作目录,或者文件目录.
