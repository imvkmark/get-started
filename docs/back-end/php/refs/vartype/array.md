---
description: '与变量和类型相关的扩展主要包括数组、常量与函数。数组用于存储多个相同类型的元素；常量定义不可变的值；函数封装可复用的操作。这些扩展增强了数据组织、代码复用和类型安全性。'
lastUpdated: '2026-06-17 18:03:14'
head:
  - - meta
    - name: 'og:title'
      content: 'Array(数组) '
...
![](https://file.wulicode.com/feishu-images/1dbe47bf2a1eba94961fa002903994dd.png)
