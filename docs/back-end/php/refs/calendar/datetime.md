---
description: 'Datetime是一个日历和事件相关的扩展，用于处理日期和时间。安装简单，支持灵活的配置，提供丰富的函数如日期计算、格式化、时区转换等，方便开发者高效管理时间相关功能。'
lastUpdated: '2026-06-17 23:03:29'
head:
  - - meta
    - name: 'og:title'
      content: 'Datetime  - 时间日期'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
...
![](https://file.wulicode.com/feishu-images/6cdaf1a0bad2a437ef1c0de17800e2d7.png)
...
![](https://file.wulicode.com/feishu-images/dc00090785040e45c2283fd6d205d1c3.png)
...
![](https://file.wulicode.com/feishu-images/e4ef75e6a80b759aba78da0c9d3b24df.png)
...
![](https://file.wulicode.com/feishu-images/848969f75b34b0b4504bde5c6429e002.png)
