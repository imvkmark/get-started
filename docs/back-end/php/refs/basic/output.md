---
description: 'PHP输出控制函数用于管理脚本输出，允许在输出开始后发送HTTP头信息。output_buffering可全局开启输出缓冲（默认0），optionally设置缓冲大小。output_handler可指定函数处理所有输出，仅限内置函数，不能与mb_output_handler或ob_iconv_handler同时使用。'
lastUpdated: '2026-06-18 00:16:04'
head:
  - - meta
    - name: 'og:title'
      content: '输出控制'
...
![](https://file.wulicode.com/feishu-images/2e897389d478b864d2bdaf4d68a73a87.png)
...
![](https://file.wulicode.com/feishu-images/282ec604f5a68c6bf46fb983fb4e3a90.png)
...
![](https://file.wulicode.com/feishu-images/708ee34ea62c87229f8aca901ea6808f.png)
