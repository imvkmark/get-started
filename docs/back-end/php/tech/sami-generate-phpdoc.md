---
description: '为方法, 类, 函数生成文档已经成为了程序员的习惯, 所以需要知道通过源代码生成独立的文档. 本文中我会介绍Sami , 一款 新的 API 文档生成工具.DocBlock 是插入到 类, 接口, 方法, 属性顶部的多行注释, 为了阐明这个, 我们看下 Laravel 中的代码片段DocBlock 开始于 /**, 结束于 */, 每行之间使用 *. 当定义一个类属性或者方法的时候, 我们会写一个描述或者多个注释来描述这个功能. 在这些示例中 @param 和 @var 会被用到. 你可以访问 phpDocumentor 官方网站来熟悉每个标签的用法.世界上充满许多文档生成'
lastUpdated: '2025-12-12 13:58:00'
head: 
  - - meta
    - name: 'og:title'
  ...
  - - meta
    - name: 'og:description'
      content: '为方法, 类, 函数生成文档已经成为了程序员的习惯, 所以需要知道通过源代码生成独立的文档. 本文中我会介绍Sami , 一款 新的 API 文档生成工具.DocBlock 是插入到 类, 接口, 方法, 属性顶部的多行注释, 为了阐明这个, 我们看下 Laravel 中的代码片段DocBlock 开始于 /**, 结束于 */, 每行之间使用 *. 当定义一个类属性或者方法的时候, 我们会写一个描述或者多个注释来描述这个功能. 在这些示例中 @param 和 @var 会被用到. 你可以访问 phpDocumentor 官方网站来熟悉每个标签的用法.世界上充满许多文档生成'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/php/tech/sami-generate-phpdoc.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/notion/c6/c61d15cc8ff13a0b418cc7b22045059d.png?x-oss-process=image/resize,m_mfit,w_400'
---
# 使用 Doctum/Sami 生成 PHP 文档



::: warning  <img src="https://file.wulicode.com/notion/df/df74788751515ae874871d8aa75864b6.svg" style="width:17px;position:relative;top:4px;border:none;display:inline;">  当前 sami 已经不维护, 后续使用 [code-lts/doctum](https://github.com/code-lts/doctum) 替代, API 完全一致
...
![](https://file.wulicode.com/notion/c6/c61d15cc8ff13a0b418cc7b22045059d.png)
...
![](https://file.wulicode.com/notion/64/644fdccc55a823d7b97b686418ae7fd0.gif)
...
![](https://file.wulicode.com/notion/c5/c5abbdd67844e5fa4c7af3b22825619f.png)
