---
description: '使用PECL安装PHP扩展，如Redis、mcrypt和Swoole，并进行性能优化：开启OPcache脚本缓存、安装应用缓存、用ImageMagick替代GD、设置合适Swap值、遵循PHP并发建议及MySQL数据库版本建议。'
lastUpdated: '2026-06-18 08:17:19'
head:
  - - meta
    - name: 'og:title'
      content: '使用 pecl 安装 Php 扩展'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: '使用PECL安装PHP扩展，如Redis、mcrypt和Swoole，并进行性能优化：开启OPcache脚本缓存、安装应用缓存、用ImageMagick替代GD、设置合适Swap值、遵循PHP并发建议及MySQL数据库版本建议。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//back-end/php/primer/install-extension-use-pecl.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/ee3fa6475a08defb2e219fde093a8097.png'
---
# 使用 pecl 安装 Php 扩展
...
pecl 是属于 php 扩展库的一个工具, pecl 可以安装 [https://pecl.php.net/](https://pecl.php.net/) 文章中提到使用 remi 的仓库来安装 php 那同样安装 pecl 也使用 remi 的仓库来安装
...
![](https://file.wulicode.com/feishu-images/ee3fa6475a08defb2e219fde093a8097.png)
