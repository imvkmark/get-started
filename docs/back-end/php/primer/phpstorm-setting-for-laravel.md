---
description: '使用PhpStorm开发Laravel应用时，安装Laravel IDE助手和Laravel插件可提升效率：IDE助手为类、Facades等提供代码补全，插件提供导航、模板、路由支持等。'
lastUpdated: '2026-06-21 20:40:27'
head:
  - - meta
    - name: 'og:title'
      content: '⚠️ 使用 PhpStorm 开发 Laravel 应用'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
...
![](https://file.wulicode.com/feishu-images/703f017997ccd549e9a024075370ae2f.png)
