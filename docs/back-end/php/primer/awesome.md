...
- [vtsykun/packeton](https://github.com/vtsykun/packeton) - 🔥 可自由部署的开源私有包管理平台
...
- [composer/satis](https://github.com/composer/satis) : [不推荐] 一个静态 Composer 存储库生成器, 打包速度慢
- [repman.io](http://repman.io) -  [不推荐] 私有包解决方案

  - 不支持 ssh 对仓库加密获取
  - 版本支持有问题 会提示 RuntimeException
...
- [Sami](https://github.com/fabpot/Sami) - 🚷 一个API文档生成器 [官方归档, 替代品 https://github.com/code-lts/doctum] [04/2025]
...
- https://github.com/bobthecow/psysh - 另一个微型PHP REPL (Read / Echo / Print / Loop)
...
- [overtrue/pinyin](https://github.com/overtrue/pinyin) - [中文]基于词库的中文转拼音优质解决方案
