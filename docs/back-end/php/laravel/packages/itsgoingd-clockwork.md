...
---
# Clockwork - 在浏览器中调试 PHP

## 介绍

![](https://file.wulicode.com/feishu-images/4585c3dc68b8563289648e1e10dba4ae.png)
...
![](https://file.wulicode.com/feishu-images/f55e3251c835b569f83b926780e8846c.png)
...
![](https://file.wulicode.com/feishu-images/4d1d395e91a5daadbfebe5d2a40c829f.png)
...
![](https://file.wulicode.com/feishu-images/ac7eb75fcf0749847687c2bcf6071680.png)
...
![](https://file.wulicode.com/feishu-images/8f49817fd39e87c2d181c0af9d6a8256.png)
...
![](https://file.wulicode.com/feishu-images/b312089f5c8bb16bc59595f1720dedc1.png)
...
![](https://file.wulicode.com/feishu-images/7601dc3580fa95c35080d55a322b3a47.png)
...
![](https://file.wulicode.com/feishu-images/b3fb8a4c990340435ce0cc3eb1066c86.png)
...
![](https://file.wulicode.com/feishu-images/7bee65d74f19ce032c4d9f4d897ebe4d.png)
...
- 通过调用将一个或多个数据源添加到 Clockwork 实例
- `$clockwork->setStorage`
- 通过调用在 Clockwork 实例上实例化并设置存储类
- *应用程序运行*
- `$clockwork->resolveRequestresolve`
- 被调用，导致 Request 对象在所有配置的数据源上通过
- 方法，每个都将相关数据添加到 Request 实例
- `$clockwork->storeRequest`
- 被调用，通过集合存储实现持久化 Request 对象
- `X-Clockwork-VersionX-Clockwork-Id`
- 并
- 在响应中设置标头
...
- 存储的请求
- `find($id)`
- 返回具有指定 ID 或 null 的单个请求
- `latest()`
- 返回单个最新请求或 null
- `previous($id, $count = null)`
- 返回指定 ID 之前收到的请求数组，可选择限制为指定计数
- `next($id, $count = null)`
- 返回指定 ID 后收到的请求数组，可选择限制为指定计数
