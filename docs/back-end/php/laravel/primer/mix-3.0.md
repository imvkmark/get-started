---
description: 'Laravel-mix 3.0中文文档概述了前端构建工具的使用：包括基本示例、Less/Sass预处理器、项目安装、独立项目配置、NPM集成、常见问题排障；API部分涵盖Vue/React组件、代码分离、版本化、热模块替换、浏览器刷新；高级功能有PostCSS、文件复制、自动加载、事件钩子、LiveReload及扩展Mix等。'
lastUpdated: '2026-06-21 20:40:04'
head:
  - - meta
    - name: 'og:title'
      content: '[译] Laravel-mix 3.0 中文文档'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: 'Laravel-mix 3.0中文文档概述了前端构建工具的使用：包括基本示例、Less/Sass预处理器、项目安装、独立项目配置、NPM集成、常见问题排障；API部分涵盖Vue/React组件、代码分离、版本化、热模块替换、浏览器刷新；高级功能有PostCSS、文件复制、自动加载、事件钩子、LiveReload及扩展Mix等。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//back-end/php/laravel/primer/mix-3.0.html'
---
...
laravel 自带了一个 `./resources/assets/js/components/Example.vue` 文件，运行完成后会有一个系统通知。**5 . 更新视图**laravel 自带一个欢迎页面，我们可以用这个来做示例，修改一下：
...
laravel mix 包罗万象，支持 vue 组件编译，如果你不使用 vue 的话，可以忽略这块。单文件组件是 vue 最重要的特征。在一个文件里为一个组件定义模板，脚本，样式表。./resources/assets/js/app.js
