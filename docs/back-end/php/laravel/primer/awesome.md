---
description: '从DuckDuckGo搜索Laravel包时，添加“packagist”作为首词可直达官方目录。Packagist是Laravel及Composer包的官方索引。Laravel Collective维护从Laravel核心移除的组件，如注解、远程SSH和表单/HTML。'
lastUpdated: '2026-06-21 20:39:33'
head:
  - - meta
    - name: 'og:title'
      content: 'Awesome Laravel'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: '从DuckDuckGo搜索Laravel包时，添加“packagist”作为首词可直达官方目录。Packagist是Laravel及Composer包的官方索引。Laravel Collective维护从Laravel核心移除的组件，如注解、远程SSH和表单/HTML。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//back-end/php/laravel/primer/awesome.html'
---
# Awesome Laravel
...
- [Laracasts](https://laracasts.com/) - The *de facto* standard tutorials for Laravel developed by Jeffrey Way. (Some free Laracasts videos on YouTube [here](https://www.youtube.com/user/laracasts).)
