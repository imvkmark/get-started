---
description: '源码阅读介绍了应用初始化流程：实例化App容器和PackageManifest，注册基本绑定与事件处理（如EventServiceProvider、LogServiceProvider、RoutingServiceProvider），最后注册系统别名，包括单例Kernel和异常处理。'
lastUpdated: '2026-06-17 22:36:55'
head:
  - - meta
    - name: 'og:title'
      content: '源码阅读 - 初始 (2) 初始化 App'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: '源码阅读介绍了应用初始化流程：实例化App容器和PackageManifest，注册基本绑定与事件处理（如EventServiceProvider、LogServiceProvider、RoutingServiceProvider），最后注册系统别名，包括单例Kernel和异常处理。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//back-end/php/laravel/refs/reading-init-app.html'
---
# 源码阅读 - 初始 (2) 初始化 App
...
**Illuminate/Foundation/Application::\_\_construct()**
