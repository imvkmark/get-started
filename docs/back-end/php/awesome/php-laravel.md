---
description: ''
lastUpdated: '2025-12-06 14:22:00'
head: 
  - - meta
    - name: 'og:title'
      content: 'Awesome Laravel - 一款优秀的艺术家框架'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
  ...
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/awesome/language/php-laravel.html'
---
# Awesome Laravel - 一款优秀的艺术家框架



::: tip  <img src="https://file.wulicode.com/notion/e7/e70373a5c235cfc0ebbca346579c85a0.svg" style="width:17px;position:relative;top:4px;border:none;display:inline;">  [TimothyDJones/awesome-laravel](https://github.com/TimothyDJones/awesome-laravel)<br />
A curated list of delightful [Laravel](http://laravel.com/) PHP framework [packages](about:blank#packages) and [resources](about:blank#resources). Inspired by other [awesome lists](https://github.com/bayandin/awesome-awesomeness)
...
- [Laravel Password Exposed Validation Rule](https://github.com/DivineOmega/laravel-password-exposed-validation-rule) - Adds validation rule to Laravel to check if user password has been compromised in data breach. [06/25/2018] – [Laravel 5 Very Basic Auth](https://github.com/olssonm/l5-very-basic-auth) – HTTP Basic Authentication without the need for a database [09/07/2017]
...
- [Laravel iDoc](https://github.com/ovac/idoc) - Automatically generate interactive API documentation from your existing Laravel routes. Take a look at the [example documentation](https://www.ovac4u.com/idoc/live). Inspired by [Laravel API Documentation Generator](https://github.com/mpociot/laravel-apidoc-generator)(2020.11)
...
- [sqli](https://github.com/antonioribeiro/sqli) - Laravel 4 Artisan SQL REPL (interactive tool), similar to  _tinker_  for SQL queries.
...
- [Laravel Excel](https://laravel-excel.com/) - 👍 具有 Laravel 风格的 PhpSpreadsheet，围绕 PhpSpreadsheet 的一个简单而优雅的包装器，简化数据的导出和导入操作 [04/2025]
...
- [dd](https://github.com/marktopper/dd) - Laravel 4 helper similar to [new ](https://laravel-news.com/2014/12/laravel-5-dd-gets-upgrade/)[dd](https://laravel-news.com/2014/12/laravel-5-dd-gets-upgrade/)[ from Laravel 5](https://laravel-news.com/2014/12/laravel-5-dd-gets-upgrade/).
...
- [Laravel 5 Beauty](http://laravelcoding.com/blog?tag=L5%20Beauty) - Comprehensive, step-by-step tutorial for building a complete application with Laravel 5. [08/13/2015]
...
- [External List of Laravel Applications](https://github.com/unicodeveloper/awesome-opensource-webapps#laravel) [03/28/2016]
...
- [Listymail](https://listymail.com/) - Free online tool for email distribution lists. [02/15/2016] - **** [Php Coding Stuff](https://www.phpcodingstuff.com/) - Site to Search any type of laravel project.
...
- [Your One-Stop Guide to ](http://code.tutsplus.com/tutorials/your-one-stop-guide-to-laravel-commands--net-30349)[Laravel](http://code.tutsplus.com/tutorials/your-one-stop-guide-to-laravel-commands--net-30349)[ Artisan Commands](http://code.tutsplus.com/tutorials/your-one-stop-guide-to-laravel-commands--net-30349)
...
- Another [Laravel Cheat Sheet (PDF)](https://docs.google.com/viewer?url=http%3A%2F%2Fblog.kyawzinwin.me%2Fwp-content%2Fuploads%2F2014%2F03%2FLaravel-Cheatsheet.pdf)
- Another [Laravel Cheat Sheet (PDF)](https://docs.google.com/viewer?url=https%3A%2F%2Fgithub.com%2FTuraylon%2Flaravel4-cheat-sheet%2Fraw%2Fmaster%2Fcheat-sheet-A4.pdf) [04/30/2015]
- [Laravel Guide](http://laravel-guide.readthedocs.io/) - Easy-to-read and navigate view of the Laravel documentaiton. [05/17/2016]
- [Laravel The Right Way](http://www.laravelbestpractices.com/) -  _Opinionated_  guide to Laravel development best practices, inspired by [PHP The Right Way](http://www.phptherightway.com/).
...
- [Vuebnb](https://github.com/fsvwd/vuebnb) - An Airbnb clone site built with [Vue.JS](https://vuejs.org/] and Laravel as tutoril from upcoming book  _Full Stack Vue Web Development_ .
...
- [Laragen](http://makzumi.com/laragen/) - Online tool for generating Laravel views for  _index_ ,  _create_ , and  _edit_ , based on your model definition.
...
- [Laravel ](https://github.com/cpriego/valet-ubuntu)[for Ubuntu](https://github.com/cpriego/valet-ubuntu) - Port of [Laravel Valet](http://laravel.com/docs/valet) (for Mac) to run on Ubuntu. [05/31/2016]
