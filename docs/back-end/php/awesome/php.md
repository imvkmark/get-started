---
description: '其他的相关依赖管理Web开发框架其他Web开发框架来自Web开发框架的独立组件微型框架和路由其他相关的微型框架和路由模板化和词法分析的库和工具预处理工具来生成Web页面的内容。用于HTTP和网站爬取的库解析URL的库发送和解析邮件的库文件处理和MIME类型检测库处理流的库实现依赖注入设计模式的库处理图像的库测试代码和生成测试数据的库持续集成的库和应用生成项目文档的库生成安全的随机数，加密数据，扫描漏洞的库处理和存储密码的库和工具分析，解析和处理代码库的库的工具调试代码的库和工具项目构建和自动化工具自'
lastUpdated: '2026-01-11 10:25:00'
head: 
  - - meta
    - name: 'og:title'
      content: 'Awesome PHP - 即时编译语言'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: '其他的相关依赖管理Web开发框架其他Web开发框架来自Web开发框架的独立组件微型框架和路由其他相关的微型框架和路由模板化和词法分析的库和工具预处理工具来生成Web页面的内容。用于HTTP和网站爬取的库解析URL的库发送和解析邮件的库文件处理和MIME类型检测库处理流的库实现依赖注入设计模式的库处理图像的库测试代码和生成测试数据的库持续集成的库和应用生成项目文档的库生成安全的随机数，加密数据，扫描漏洞的库处理和存储密码的库和工具分析，解析和处理代码库的库的工具调试代码的库和工具项目构建和自动化工具自'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/awesome/language/php.html'
---
# Awesome PHP - 即时编译语言



::: tip  <img src="https://file.wulicode.com/notion/e7/e70373a5c235cfc0ebbca346579c85a0.svg" style="width:17px;position:relative;top:4px;border:none;display:inline;">  [ziadoz/awesome-php](https://github.com/ziadoz/awesome-php)<br />
...
- [Packagist](https://packagist.org/) - Php Composer 包仓库
- [composer/installers](https://github.com/composer/installers) :  一个多框架Composer库安装器
- [FriendsOfPHP/pickle](https://github.com/FriendsOfPHP/pickle) - 一个PHP扩展安装器
- [Private Packagist](https://packagist.com/) - 私有的 packagist 包管理器
- [vtsykun/packeton](https://github.com/vtsykun/packeton) - 🔥 可自由部署的 composer 私有包管理工具
- [composer/satis](https://github.com/composer/satis) :  ⚠️ 一个静态 Composer 存储库生成器, 打包速度慢
...
- [Laravel](https://laravel.com/) -  🔥 Web 开发艺术家的 PHP 框架
...
- [phpstan](https://phpstan.org/) : 一个静态测试库
...
- [Sami](https://github.com/fabpot/Sami) - 🚷 一个API文档生成器 [官方归档, 替代品 [code-lts/doctum](https://github.com/code-lts/doctum)] [04/2025]
...
- [bobthecow/psysh](https://github.com/bobthecow/psysh) - 另一个微型PHP REPL (Read / Echo / Print / Loop)
...
- [Disproving the Single Quotes Myth](http://nikic.github.com/2012/01/09/Disproving-the-Single-Quotes-Performance-Myth.html)：一篇关于单引号，双引号字符串性能的文章
...
- 关于PHP源代码的系列 - 垃圾收集： [1](http://www.php.net/manual/en/features.gc.refcounting-basics.php) [2](http://www.php.net/manual/en/features.gc.collecting-cycles.php) [3](http://www.php.net/manual/en/features.gc.performance-considerations.php) 关于PHP垃圾收集原理的系列

## 项目

### CMS

- [MetInfo](https://www.metinfo.cn/) - 🔥 米拓, 企业级CMS建站系统
