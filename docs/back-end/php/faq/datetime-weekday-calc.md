---
description: '根据ISO 8601标准，周从星期一开始，每年第一个星期包含第一个星期四（即1月4日）。年度可能有52或53周，年底周计算需遵循此定义。PHP的周函数按ISOWeek实现，年底易出错，需根据此定义改写。'
lastUpdated: '2026-06-17 23:03:00'
head:
  - - meta
    - name: 'og:title'
      content: '关于 Php 的周计算'
  ...
  - - meta
    - name: 'og:description'
      content: '根据ISO 8601标准，周从星期一开始，每年第一个星期包含第一个星期四（即1月4日）。年度可能有52或53周，年底周计算需遵循此定义。PHP的周函数按ISOWeek实现，年底易出错，需根据此定义改写。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//back-end/php/faq/datetime-weekday-calc.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/b70cedebf74d06eb66179dca768dc5a6.png'
---
# 关于 Php 的周计算
...
![](https://file.wulicode.com/feishu-images/b70cedebf74d06eb66179dca768dc5a6.png)
