...
lastUpdated: '2026-06-22 02:50:37'
head:
  - - meta
    - name: 'og:title'
...
::: info 📖<p>扩展阅读</p><ul><li>[jenv - 管理当前的 Java 环境 ](/back-end/java/primer/jenv-java-environment--version-manager.md)</li><li>[sdkman - 管理多个 sdk 的工具](/development/tools/sdkman.md)</li></ul>:::
