---
description: '该章节介绍了Java中接口的概念、属性、默认方法及冲突解决，lambda表达式的语法、函数式接口与方法引用，以及内部类的访问规则、匿名内部类和静态内部类等特性，并涉及服务加载器和代理机制。'
lastUpdated: '2026-06-30 13:30:31'
head:
  - - meta
    - name: 'og:title'
  ...
  - - meta
    - name: 'og:description'
      content: '该章节介绍了Java中接口的概念、属性、默认方法及冲突解决，lambda表达式的语法、函数式接口与方法引用，以及内部类的访问规则、匿名内部类和静态内部类等特性，并涉及服务加载器和代理机制。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/back-end/java/core/6-interface-lambda.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/75d7696191dbabaaac6be2ec3892ff77.png'
---
# 6.接口, lambda 表达式与内部类
...
![](https://file.wulicode.com/feishu-images/75d7696191dbabaaac6be2ec3892ff77.png)
...
![](https://file.wulicode.com/feishu-images/ee0ae4cb9176eca7cf06d032c668dab0.png)

![](https://file.wulicode.com/feishu-images/8196b031111148ef71c9fccfde3ddfc6.png)
