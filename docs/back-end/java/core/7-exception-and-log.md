---
description: '该章节涵盖异常处理（分类、声明、抛出、创建异常类，捕获异常、多个异常、再抛出与异常链、finally子句、try-with-Resources、堆栈轨迹分析）、使用异常技巧、断言（使用、启用/禁用、参数检查、提供假设文档）以及日志（基本/高级日志、配置、本地化、处理器、过滤器、格式化器、调试技巧）。'
lastUpdated: '2026-06-29 23:59:06'
head:
  - - meta
    - name: 'og:title'
      content: '7.异常, 断言, 日志'
  ...
  - - meta
    - name: 'og:description'
      content: '该章节涵盖异常处理（分类、声明、抛出、创建异常类，捕获异常、多个异常、再抛出与异常链、finally子句、try-with-Resources、堆栈轨迹分析）、使用异常技巧、断言（使用、启用/禁用、参数检查、提供假设文档）以及日志（基本/高级日志、配置、本地化、处理器、过滤器、格式化器、调试技巧）。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/back-end/java/core/7-exception-and-log.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/83fc495244ee2f2eeb7671ff69e03ddc.png'
---
# 7.异常, 断言, 日志
...
![](https://file.wulicode.com/feishu-images/83fc495244ee2f2eeb7671ff69e03ddc.png)
