---
description: '本书全面介绍Java语言核心特性：从基础语法、面向对象编程（封装、继承）到高级特性如接口、lambda、泛型、集合框架，并涵盖异常处理、GUI编程（AWT/Swing）及实用调试技巧。'
lastUpdated: '2026-06-30 13:29:18'
head:
  - - meta
    - name: 'og:title'
      content: 'Java 编程 [核心]'
  ...
  - - meta
    - name: 'og:description'
      content: '本书全面介绍Java语言核心特性：从基础语法、面向对象编程（封装、继承）到高级特性如接口、lambda、泛型、集合框架，并涵盖异常处理、GUI编程（AWT/Swing）及实用调试技巧。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/back-end/java/core/index.html'
---
# Java 编程 [核心]
