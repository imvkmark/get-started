---
description: 'Java基础数据类型分为内置数据类型（如byte、short、int、long、float、double、char）与引用数据类型。每种内置类型有对应的包装类（如java.lang.Byte等），并具有特定取值范围。此外，还涉及转义序列及基础语法要点。'
lastUpdated: '2026-06-20 12:14:36'
head:
  - - meta
    - name: 'og:title'
      content: 'Java 学习 02 - 基础数据类型-基础语法 '
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
...
**常量**使用 `final` 关键词来修饰, 和php中final 的意思相同, 意思是不能修改的, 遵循设计规范, 全都是大写标识
