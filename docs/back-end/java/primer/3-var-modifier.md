---
description: 'Java变量定义要点包括声明与初始化。修饰符分为访问控制修饰符（如public、private、protected）和非访问修饰符（如static、final、abstract、synchronized等）。访问控制修饰符控制可见性，非访问修饰符改变变量或方法的行为。参考文档可深化理解。'
lastUpdated: '2026-06-22 12:03:52'
head:
  - - meta
    - name: 'og:title'
      content: 'Java 学习 03 - 变量-修饰符'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
