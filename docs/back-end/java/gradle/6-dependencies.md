---
description: '本章介绍Gradle依赖管理，涵盖术语、依赖管理基础、声明存储库（包括公开、自定义、多个存储库）、支持的类型（Maven、MavenLocal、Ivy）、存储库内容过滤、元数据来源、插件与构建存储库、集中声明及传输协议配置（如HTTP(S)认证、AWS S3、Google Cloud、凭据处理）。'
lastUpdated: '2026-06-18 09:47:00'
head:
  - - meta
    - name: 'og:title'
      content: '6 使用依赖项'
  ...
  - - meta
    - name: 'og:description'
      content: '本章介绍Gradle依赖管理，涵盖术语、依赖管理基础、声明存储库（包括公开、自定义、多个存储库）、支持的类型（Maven、MavenLocal、Ivy）、存储库内容过滤、元数据来源、插件与构建存储库、集中声明及传输协议配置（如HTTP(S)认证、AWS S3、Google Cloud、凭据处理）。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//back-end/java/gradle/6-dependencies.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/4d70f0203f58c16d7daa75494b0f5424.png'
---
# 6 使用依赖项
...
![](https://file.wulicode.com/feishu-images/4d70f0203f58c16d7daa75494b0f5424.png)
...
![](https://file.wulicode.com/feishu-images/edd5f90ff6cc2be6fee95894b87191fa.png)