---
description: '在 iOS9 之前，要在浏览器中唤醒 APP，我们通常使用 scheme。这种方式需要提前判断系统中是否安装了能够响应此 scheme 的 app，并且这种方式在微信被禁用。请按照以下步骤将您的应用和网站相关联以获取 Universal Links：以上是从苹果文档翻译而来。登录苹果开发者后台，在设置证书的页面找到 Identifiers -> App ID（设置包名）里，在对应的 BundleId 下勾选 Associated Domains 如下图按照图中的步骤添加好 Universal Links注意点:在 Associated Domains 里面配置的 Uni'
lastUpdated: '2023-12-05 18:12:00'
head: 
  - - meta
    - name: 'og:title'
  ...
  - - meta
    - name: 'og:description'
      content: '在 iOS9 之前，要在浏览器中唤醒 APP，我们通常使用 scheme。这种方式需要提前判断系统中是否安装了能够响应此 scheme 的 app，并且这种方式在微信被禁用。请按照以下步骤将您的应用和网站相关联以获取 Universal Links：以上是从苹果文档翻译而来。登录苹果开发者后台，在设置证书的页面找到 Identifiers -> App ID（设置包名）里，在对应的 BundleId 下勾选 Associated Domains 如下图按照图中的步骤添加好 Universal Links注意点:在 Associated Domains 里面配置的 Uni'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/mobile/ios/universal-links.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/notion/42/426dad5db28d957579ab8bc2b609c197.png?x-oss-process=image/resize,m_mfit,w_400'
---
...
![](https://file.wulicode.com/notion/42/426dad5db28d957579ab8bc2b609c197.png)

### 在 Xcode(11)里面添加 Associated Domains

按照图中的步骤添加好 Universal Links

![](https://file.wulicode.com/notion/cd/cd8131baa38de46baec7999bf132fc0f.png)
...
![](https://file.wulicode.com/notion/7c/7c673c68d3eed7a85567cf189abb074c.png)

ios 中的相关配置

在 xcode 的 info.plist 里面配置一下，配置如下图

![](https://file.wulicode.com/notion/c6/c63a984db93424efb33b4548756a0831.png)
...
![](https://file.wulicode.com/notion/3c/3c47e0feef83730c4fc74a3da702498b.png)
