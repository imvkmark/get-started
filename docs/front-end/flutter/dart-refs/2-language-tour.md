---
description: '该文档提供了Dart编程语言的语法概览，涵盖变量定义、内置类型（数字、字符串、布尔、列表）、函数（参数、匿名函数）、运算符、流程控制（if/else、for、while、switch等）、异常处理、类（构造函数、抽象类、mixin）、泛型、库与可见性、异步编程（Future、Stream）等核心内容。'
lastUpdated: '2026-06-30 17:17:09'
head:
  - - meta
    - name: 'og:title'
      content: '2. 语法概览'
  ...
  - - meta
    - name: 'og:description'
      content: '该文档提供了Dart编程语言的语法概览，涵盖变量定义、内置类型（数字、字符串、布尔、列表）、函数（参数、匿名函数）、运算符、流程控制（if/else、for、while、switch等）、异常处理、类（构造函数、抽象类、mixin）、泛型、库与可见性、异步编程（Future、Stream）等核心内容。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/front-end/flutter/dart-refs/2-language-tour.html'
---
# 2. 语法概览
...
**重写类成员** 重写类方法等可以使用 @override 注解来表示
...
如果调用了不存在方法将触发 noSuchMethod 方法, 查看 [更多资料](https://github.com/dart-lang/language/blob/main/archive/feature-specifications/nosuchmethod-forwarding.md)
...
未声明构造函数, 使用 mixin 关键词替代 class dart
