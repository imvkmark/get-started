...
head:
  ...
  - - meta
    - name: 'og:description'
      content: '本文介绍了使用ApiDoc编写接口文档的方法，包括安装（可能需要sudo权限）、生成规则（apidoc -i code_dir -o output_dir），以及项目中基于Laravel Artisan封装的函数。同时说明了参数说明、写法规范、参数对齐、apiName命名规范、返回值约定与对齐等要点。'
  - - meta
    - name: 'og:url'
