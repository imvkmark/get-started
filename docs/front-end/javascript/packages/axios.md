---
description: 'axios是一个基于Promise的HTTP客户端，支持浏览器和Node.js，具有安装简便、请求方法别名、并发请求、创建实例、配置默认值、拦截器、错误处理及取消请求等功能，兼容TypeScript。'
lastUpdated: '2026-06-30 17:03:47'
head:
  - - meta
    - name: 'og:title'
      content: 'axios 简介'
  ...
  - - meta
    - name: 'og:description'
      content: 'axios是一个基于Promise的HTTP客户端，支持浏览器和Node.js，具有安装简便、请求方法别名、并发请求、创建实例、配置默认值、拦截器、错误处理及取消请求等功能，兼容TypeScript。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/front-end/javascript/packages/axios.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/452fcd22fa57061e4fbf845779b1c466.png'
---
# axios 简介

::: info 🔗

转发文章, 原文地址 : [axios全攻略](https://ykloveyxk.github.io/2017/02/25/axios%E5%85%A8%E6%94%BB%E7%95%A5/)
...
![](https://file.wulicode.com/feishu-images/452fcd22fa57061e4fbf845779b1c466.png)
