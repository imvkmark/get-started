---
description: '描述搭建无刷新前端框架的流程：包括逻辑设计、目录结构（dist/index.html、src/index.js、webpack配置、babel与jshint配置），以及启动服务或参考文章。'
lastUpdated: '2026-06-30 22:47:02'
head:
  - - meta
    - name: 'og:title'
  ...
  - - meta
    - name: 'og:description'
      content: '描述搭建无刷新前端框架的流程：包括逻辑设计、目录结构（dist/index.html、src/index.js、webpack配置、babel与jshint配置），以及启动服务或参考文章。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/front-end/javascript/extend-reading/build-live-reload-framework.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/123c5e8c2a490c71f2e22de460c73c7e.png'
---
# 搭建一个可以写前端代码的无刷新框架

::: warning ⚠️

现在有更好的方案 : Laravel Mix, 如果需要学习可以参考此文档, https://github.com/imvkmark/fe-refresh-demo
...
![](https://file.wulicode.com/feishu-images/123c5e8c2a490c71f2e22de460c73c7e.png)
