---
description: 'Flutter安装与环境设置涵盖安装路径配置、加速pub和storage源（如清华源）、频道切换与升级、Android及iOS工具链安装、以及解决Gradle卡顿等常见问题。'
lastUpdated: '2026-07-01 08:11:28'
head:
  - - meta
    - name: 'og:title'
      content: 'Flutter 安装和环境设置'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: 'Flutter安装与环境设置涵盖安装路径配置、加速pub和storage源（如清华源）、频道切换与升级、Android及iOS工具链安装、以及解决Gradle卡顿等常见问题。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/front-end/app/flutter/primer/install.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/9c856436b13b771a0224dabbaacf5c02.png'
---
# Flutter 安装和环境设置
...
![](https://file.wulicode.com/feishu-images/9c856436b13b771a0224dabbaacf5c02.png)
...
![](https://file.wulicode.com/feishu-images/4694ec01f8f3e72b47dbd65bbd9e4506.png)

查询结果如下所示

![](https://file.wulicode.com/feishu-images/b39180d7c913cf0404e7d1eeb2226d0a.png)