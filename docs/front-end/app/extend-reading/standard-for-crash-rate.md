---
description: '移动互联网发展推动应用数量激增，2014年Google Play Store应用总量达143万款，首次超过苹果App Store的121万款。然而，性能问题如闪退、卡顿、崩溃等严重影响应用命运，组合超1亿种，涉及大量机型、操作系统和运营商。'
lastUpdated: '2026-07-01 08:07:54'
head:
  - - meta
    - name: 'og:title'
      content: 'App 的崩溃率标准'
  ...
  - - meta
    - name: 'og:description'
      content: '移动互联网发展推动应用数量激增，2014年Google Play Store应用总量达143万款，首次超过苹果App Store的121万款。然而，性能问题如闪退、卡顿、崩溃等严重影响应用命运，组合超1亿种，涉及大量机型、操作系统和运营商。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/front-end/app/extend-reading/standard-for-crash-rate.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/7980c535698e80cc9cbce499458688e4.png'
---
# App 的崩溃率标准
...
![](https://file.wulicode.com/feishu-images/7980c535698e80cc9cbce499458688e4.png)

图1：听云提出的移动应用崩溃率标准

报告统计显示，当iOS的崩溃率超过8‰, Android的崩溃率超过4‰的时候活跃用户有明显下降态势，并且这两大系统在2014年全年平均崩溃率均超出标准值，普遍存在轻微隐患。

![](https://file.wulicode.com/feishu-images/54c462dc6097a3e2c07c1b49f0227658.png)

图2：iOS系统崩溃分布

在iOS系统中，iOS5.X以及iOS8是目前崩溃率最高的操作系统，相较于其它系统，iOS7X整体崩溃表现稳定，崩溃率均低于10‰，由此看来，移动开发者必须重视移动应用对最新操作系统版本的支持以及旧版本的持续兼容问题。

![](https://file.wulicode.com/feishu-images/f4d1cbb021f4dfd0bdd4ceb60149ccae.png)

图3：Android系统崩溃分布

相较于iOS系统，Android整体崩溃率较低，其中只有Android2X系统崩溃率高于10‰，表现较差，在Android4.X版本后，崩溃率稳定在2‰-4‰

![](https://file.wulicode.com/feishu-images/eb47008afcbe00bfee66b717bae9d32f.png)
...
![](https://file.wulicode.com/feishu-images/eaf15572aaa91922571c081c58a2c3b8.png)
