---
description: 'Git gitignore文件用于指定不被Git追踪的文件。规则包含文件匹配模式。添加忽略规则有三种方式：局部方式在项目.gitignore中，可停止追踪但保留工作区文件；全局方式在用户配置中；个人方式在git-exclude中。示例忽略编译文件、包、日志和数据库、系统生成文件等。'
lastUpdated: '2026-07-02 18:12:28'
head:
  - - meta
    - name: 'og:title'
  ...
  - - meta
    - name: 'og:description'
      content: 'Git gitignore文件用于指定不被Git追踪的文件。规则包含文件匹配模式。添加忽略规则有三种方式：局部方式在项目.gitignore中，可停止追踪但保留工作区文件；全局方式在用户配置中；个人方式在git-exclude中。示例忽略编译文件、包、日志和数据库、系统生成文件等。'
  - - meta
    - name: 'og:url'
