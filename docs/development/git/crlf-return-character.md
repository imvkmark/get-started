---
description: 'AutoCRLF用于自动转换换行符；SafeCRLF则控制对混合换行符文件的处理：可拒绝提交、允许提交或仅给出警告。'
lastUpdated: '2026-07-02 18:08:00'
head:
  - - meta
    - name: 'og:title'
      content: 'AutoCRLF与SafeCRLF换行符问题'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: 'AutoCRLF用于自动转换换行符；SafeCRLF则控制对混合换行符文件的处理：可拒绝提交、允许提交或仅给出警告。'
  - - meta
    - name: 'og:url'
