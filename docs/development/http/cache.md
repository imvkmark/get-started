---
description: 'HTTP缓存通过Cache-Control、Etag、Last-Modified等头部控制。强制缓存利用Expires或Cache-Control直接使用本地副本；对比缓存通过Etag或Last-Modified验证资源是否更新。版本化URL可实现长期强制缓存。Vary用于内容协商。'
lastUpdated: '2026-06-30 22:35:36'
head:
  - - meta
    - name: 'og:title'
  ...
  - - meta
    - name: 'og:description'
      content: 'HTTP缓存通过Cache-Control、Etag、Last-Modified等头部控制。强制缓存利用Expires或Cache-Control直接使用本地副本；对比缓存通过Etag或Last-Modified验证资源是否更新。版本化URL可实现长期强制缓存。Vary用于内容协商。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/development/http/cache.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/1663ce328d0a6a8666da58c1b95810b3.png'
---
# Http 缓存简介和使用
...
![](https://file.wulicode.com/feishu-images/1663ce328d0a6a8666da58c1b95810b3.png)
...
![](https://file.wulicode.com/feishu-images/93027488381feff501f8213928d0dafb.png)
