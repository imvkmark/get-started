---
description: '地址: http://www.sublimetext.com/dev2.03.0Preferences → Key Bindings - Usertab : 补全ctrl+alt+enter : 输入复杂表达式立刻补全,Emmet的控制面板/** : 回车补全支持PHP, javascript语法插件语法提示工具根据需求自行添加快捷方式快捷键 F1, 例如PHP文件将会跳转到的地址为: http://us.php.net/lcfirstPreferences->Global Setting-Userhttp://ethanschoonover.com'
lastUpdated: '2025-12-06 11:22:00'
head: 
  - - meta
    - name: 'og:title'
      content: 'sublime text 使用简历'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: '地址: http://www.sublimetext.com/dev2.03.0Preferences → Key Bindings - Usertab : 补全ctrl+alt+enter : 输入复杂表达式立刻补全,Emmet的控制面板/** : 回车补全支持PHP, javascript语法插件语法提示工具根据需求自行添加快捷方式快捷键 F1, 例如PHP文件将会跳转到的地址为: http://us.php.net/lcfirstPreferences->Global Setting-Userhttp://ethanschoonover.com'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/development/tools/sublime-get-started.html'
---
# sublime text 使用简历
...
[thinkpixellab/flatland/archive/master.zip](https://github.com/thinkpixellab/flatland/archive/master.zip)
