...
lastUpdated: '2026-07-02 19:22:36'
head:
  - - meta
    - name: 'og:title'
  ...
  - - meta
    - name: 'og:description'
      content: '在JetBrains IDE中，可通过“设置”中的“Copyright”功能添加和管理版权信息。先定义版权模板，再设置应用范围（Scope），并将其与Scope关联。支持更新版权及为不同编程语言定制版权格式，确保代码文件自动包含版权声明。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/development/tools/jetbrains/copyright.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/a4667d382b22da0d9cff949ca94d5a5e.png'
---
...
![](https://file.wulicode.com/feishu-images/a4667d382b22da0d9cff949ca94d5a5e.png)
...
![](https://file.wulicode.com/feishu-images/4aee59523d516792659942d157d6c89a.png)
...
![](https://file.wulicode.com/feishu-images/d6d6e8f29a5c9ac6526af51e341ce91c.png)
...
![](https://file.wulicode.com/feishu-images/869dc7f7b245509980822306016bc822.png)

## 不同语种的设置

在不同的语言中会有不同的版权信息格式, 注释格式, 在菜单项目中可以根据多语种来设置不同的格式化信息.体验很好

![](https://file.wulicode.com/feishu-images/c8a819c606e3e6a94d69e9daa8a0801e.png)
