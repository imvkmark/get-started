---
description: 'VSCode的Snippets功能可通过“文件首选项用户代码片段”设置，选择或新建代码片段。语法包括占位符（\$）、占位内容的可选项以及变量，便于快速插入代码模板。'
lastUpdated: '2026-07-02 19:20:16'
head:
  - - meta
    - name: 'og:title'
      content: 'VSCode 利用 Snippets'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: 'VSCode的Snippets功能可通过“文件首选项用户代码片段”设置，选择或新建代码片段。语法包括占位符（\$）、占位内容的可选项以及变量，便于快速插入代码模板。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/development/tools/vscode/snippets-usage.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/48504c42585248d5bef72e00bfd5c2ee.jpg'
---
# VSCode 利用 Snippets

::: info 🔗

转载文章, 原文地址 :  <a href="https://juejin.im/post/5d0496415188257fff23b077">VSCode 利用 Snippets 设置超实用的代码块</a>
...
![](https://file.wulicode.com/feishu-images/48504c42585248d5bef72e00bfd5c2ee.jpg)
...
![](https://file.wulicode.com/feishu-images/63aa652a1b2eeb8322e62a0f608fb64f.jpg)
...
![](https://file.wulicode.com/feishu-images/75e59482eb9f18b474fb5d1aee300a55.jpg)

选择了参数类型之后，再次按 `TAB` , 光标会自动落到返回参数类型处（`$2` 的位置）并弹出可选项。如下所示：

![](https://file.wulicode.com/feishu-images/289c0270f045a35fe29ed1993bade47d.jpg)

选择了第二个选项之后，再次按 `TAB` ,光标自动落到我们配置的 `$0` 处，也就是 `*/` 的下一行：

![](https://file.wulicode.com/feishu-images/cbf5ffd3786f66601f6774086d54a84e.jpg)
