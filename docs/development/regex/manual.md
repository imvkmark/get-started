---
description: '该手册涵盖正则表达式基础，包括元字符、量词、贪婪与懒惰模式、子组（捕获与非捕获）、反向引用、环视断言（正向/逆向、肯定/否定）及界定匹配等核心内容。'
lastUpdated: '2026-07-02 19:13:53'
head:
  - - meta
    - name: 'og:title'
      content: '正则表达式手册'
  ...
  - - meta
    - name: 'og:description'
      content: '该手册涵盖正则表达式基础，包括元字符、量词、贪婪与懒惰模式、子组（捕获与非捕获）、反向引用、环视断言（正向/逆向、肯定/否定）及界定匹配等核心内容。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/development/regex/manual.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/d876304b0b525bda6d6e97fe962939ad.png'
---
# 正则表达式手册
...
![](https://file.wulicode.com/feishu-images/d876304b0b525bda6d6e97fe962939ad.png)

- `(\d{4})-(\d{2}-(\d{2}))`

![](https://file.wulicode.com/feishu-images/7b23a3b271dceb30a258b9304ddfb879.png)

- `((?<year>\d{4})-(?<month>\d{2})-(?<day>\d{2}))`

![](https://file.wulicode.com/feishu-images/a81b333c96bc235176b8db604b94a256.png)

- `(?<year>\d{4})-(?<date>\d{2}-(?<day>\d{2}))`

![](https://file.wulicode.com/feishu-images/d6a43960d132b492ec85093c57ec15cc.png)

- `(\d{4})-(?<date>\d{2}-(\d{2}))`

![](https://file.wulicode.com/feishu-images/cd26548f6fe9c7f72a580d4279d84ab6.png)
...
![](https://file.wulicode.com/feishu-images/fc36f86fccd67cf79307eabd36ffa90b.png)

### 非捕获子组 `(?:pattern)`

与捕获子组相反，它不捕获文本 ，也不针对组合计进行计数如： 匹配 industry 或者 industries 使用 industr(?:y|ies)写法等价于 `industry|industries`, 如果捕获则会在工具中展示 Group 信息

![](https://file.wulicode.com/feishu-images/47146dd8d797ff50ed2db819ca57ee8e.png)

### (?#comment) 注释

这种类型的分组不对正则表达式的处理产生任何影响，用于提供注释让人阅读

![](https://file.wulicode.com/feishu-images/b598bf1a4305d27f4af9b2e464baec7d.png)
...
![](https://file.wulicode.com/feishu-images/070f903afe0af6878e404ce0e03715b7.png)

- 将 `HelloWorldHelloPhp` 字符串,按照单词分隔开.变成 `Hello World Hello Php`

![](https://file.wulicode.com/feishu-images/dd93c11529e8c3e72f9a9283f4924831.png)

### 否定形式 `(?!pattern)` - 后面不是pattern

- `windows (?!\d+)` - 搜索后面不是数字的windows

![](https://file.wulicode.com/feishu-images/f670f20b409896a5948c9a2df5abad95.jpg)
...
![](https://file.wulicode.com/feishu-images/3d56e51afd39b7a1789f2ea993fc756e.jpg)

### 否定形式(?<!pattern) - 前面不是pattern

- `(?<!\w)\d+` - 查询前面不是字母数字下划线的数字串

![](https://file.wulicode.com/feishu-images/bc7788be47d7db0aa7cf84a80527b1ba.jpg)
...
![](https://file.wulicode.com/feishu-images/e75cb377e1433488b1ac66d5f09f3622.png)
...
![](https://file.wulicode.com/feishu-images/1c7870aca0b87252821433ed434276ca.png)
