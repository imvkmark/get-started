---
description: 'alternatives命令用于维护系统默认命令的符号链接，帮助管理多个版本软件的优先级，通过选项和动作设置默认运行命令，相关文档与示例提供具体用法。'
lastUpdated: '2026-07-02 12:30:11'
head:
  - - meta
    - name: 'og:title'
  ...
  - - meta
    - name: 'og:description'
      content: 'alternatives命令用于维护系统默认命令的符号链接，帮助管理多个版本软件的优先级，通过选项和动作设置默认运行命令，相关文档与示例提供具体用法。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/ops/man/system/alternatives-8.html'
---
