---
description: 'chown命令用于更改文件或目录的所有者和/或所属群组。可通过用户名称或UID、GID指定新所有者，常用选项如-R递归处理子目录。实例包括修改单一文件、递归修改目录、同时变更所有者和组等。'
lastUpdated: '2026-07-01 08:32:45'
head:
  - - meta
    - name: 'og:title'
      content: 'chown(1) - 变更文件或目录的所属用户或群组'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: 'chown命令用于更改文件或目录的所有者和/或所属群组。可通过用户名称或UID、GID指定新所有者，常用选项如-R递归处理子目录。实例包括修改单一文件、递归修改目录、同时变更所有者和组等。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/ops/man/command/chown-1.html'
---
