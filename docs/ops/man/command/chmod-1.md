---
description: 'chmod命令用于改变文件或目录的权限，支持setuid、setgid和粘滞位。权限分所有者、组、其他用户三类，可用符号（如u+w）或八进制（如755）表示。常见操作：添加组写权限、删除其他用户权限、递归修改目录权限等。注意递归时需保留执行权限，否则会报错。'
lastUpdated: '2026-07-01 08:32:37'
head:
  - - meta
    - name: 'og:title'
  ...
  - - meta
    - name: 'og:description'
      content: 'chmod命令用于改变文件或目录的权限，支持setuid、setgid和粘滞位。权限分所有者、组、其他用户三类，可用符号（如u+w）或八进制（如755）表示。常见操作：添加组写权限、删除其他用户权限、递归修改目录权限等。注意递归时需保留执行权限，否则会报错。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/ops/man/command/chmod-1.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/0a58ed8a06c5a36e03bab5aac50d2cf5.png'
---
# chmod(1) - 改变文件或目录的权限
...
![](https://file.wulicode.com/feishu-images/0a58ed8a06c5a36e03bab5aac50d2cf5.png)
