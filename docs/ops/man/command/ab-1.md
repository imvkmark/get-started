---
description: 'ab是Apache服务器的性能测试工具，用于评估HTTP服务器的负载能力。通过指定并发请求数、总请求数等参数，可模拟多用户访问场景，输出吞吐量、响应时间等关键指标。'
lastUpdated: '2026-06-18 08:41:24'
head:
  - - meta
    - name: 'og:title'
      content: 'ab(1) - Apache 服务器的性能测试工具'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: 'ab是Apache服务器的性能测试工具，用于评估HTTP服务器的负载能力。通过指定并发请求数、总请求数等参数，可模拟多用户访问场景，输出吞吐量、响应时间等关键指标。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//ops/man/command/ab-1.html'
---
