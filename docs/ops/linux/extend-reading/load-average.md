...
lastUpdated: '2026-07-02 12:25:00'
head:
  - - meta
    - name: 'og:title'
  ...
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/ops/linux/extend-reading/load-average.html'
  - - meta
    - name: 'og:image'
...
原文地址 : <a href="https://www.slyar.com/blog/linux-load-average-three-numbers.html">Linux系统平均负载3个数字的含义</a>
