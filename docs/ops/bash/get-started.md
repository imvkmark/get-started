---
description: 'Shell命令分简单和复杂。简单命令由命令、参数、可选变量赋值及重定向符号组成，以控制操作符（如回车）结束。复杂命令通过管道、循环等方式组合简单命令。'
lastUpdated: '2026-06-18 08:45:13'
head:
  - - meta
    - name: 'og:title'
      content: 'Bash'
  ...
  - - meta
    - name: 'og:description'
      content: 'Shell命令分简单和复杂。简单命令由命令、参数、可选变量赋值及重定向符号组成，以控制操作符（如回车）结束。复杂命令通过管道、循环等方式组合简单命令。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//ops/bash/get-started.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/e4db6438788909b8f245e3f65ca41ef9.png'
---
# Bash

![](https://file.wulicode.com/feishu-images/e4db6438788909b8f245e3f65ca41ef9.png)
