---
description: '该文档概述了Shell脚本中的各类运算符，包括算术运算符（+、-、*、/、%）、关系运算符（-eq、-ne、-gt、-lt、-ge、-le，仅适用于整数）、布尔运算符（!、-a、-o）、逻辑运算符（&&、||）、字符串运算符（=、!=、-z、-n）及文件测试运算符（-r、-w、-x、-f、-d、-s、-e）。通过具体示例展示各运算符的用法与返回结果。'
lastUpdated: '2026-07-02 09:30:17'
head:
  - - meta
    - name: 'og:title'
      content: '5. 运算'
  ...
  - - meta
    - name: 'og:description'
      content: '该文档概述了Shell脚本中的各类运算符，包括算术运算符（+、-、*、/、%）、关系运算符（-eq、-ne、-gt、-lt、-ge、-le，仅适用于整数）、布尔运算符（!、-a、-o）、逻辑运算符（&&、||）、字符串运算符（=、!=、-z、-n）及文件测试运算符（-r、-w、-x、-f、-d、-s、-e）。通过具体示例展示各运算符的用法与返回结果。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/ops/bash/refs/5-arithmetic.html'
---
# 5. 运算
