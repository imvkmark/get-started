---
description: 'bash 只支持一维数组。数组下标从 0 开始，下标可以是整数或算术表达式，其值应大于或等于 0。${colors[*]} 和 ${colors[@]} 这两个有比较明显的区别, 下边来说明下Code'
...
head: 
  ...
  - - meta
    - name: 'og:description'
      content: 'bash 只支持一维数组。数组下标从 0 开始，下标可以是整数或算术表达式，其值应大于或等于 0。${colors[*]} 和 ${colors[@]} 这两个有比较明显的区别, 下边来说明下Code'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/bash/manual/15-array.html'
---
# 15. 数组
