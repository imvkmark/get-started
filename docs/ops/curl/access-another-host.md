---
description: '利用libcurl实现多种连接技巧：连接远程机器、伪造Host头、按主机名连接，以及高频率请求。'
lastUpdated: '2026-06-17 10:56:42'
head:
  - - meta
    - name: 'og:title'
      content: 'Curl 另外一台机器'
  ...
  - - meta
    - name: 'og:description'
      content: '利用libcurl实现多种连接技巧：连接远程机器、伪造Host头、按主机名连接，以及高频率请求。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//ops/curl/access-another-host.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/ff3d655399651dc30a6cd962ef094637.png'
---
# Curl 另外一台机器
...
![](https://file.wulicode.com/feishu-images/ff3d655399651dc30a6cd962ef094637.png)
