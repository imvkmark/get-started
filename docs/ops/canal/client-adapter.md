---
description: '本文档介绍Client Adapter的基本说明、环境版本、整体结构及配置方法（含远程Mysql配置）。启动指南包括canal-adapter示例和管理REST接口。适配器列表涵盖logger、Hbase、RDB、ES、MongoDB、Redis等类型。'
lastUpdated: '2026-07-02 12:20:32'
head:
  - - meta
    - name: 'og:title'
  ...
  - - meta
    - name: 'og:description'
      content: '本文档介绍Client Adapter的基本说明、环境版本、整体结构及配置方法（含远程Mysql配置）。启动指南包括canal-adapter示例和管理REST接口。适配器列表涵盖logger、Hbase、RDB、ES、MongoDB、Redis等类型。'
  - - meta
    - name: 'og:url'
