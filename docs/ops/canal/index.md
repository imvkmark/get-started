---
description: 'Canal基于MySQL主备复制原理解析增量日志，实现数据同步与订阅。其架构包括Event Parser（日志解析）、Event Sink（数据过滤转换）、Event Store（存储）、Instance（实例管理）、Server（服务端）及HA机制，支持高可用。'
lastUpdated: '2026-06-18 08:45:37'
head:
  - - meta
    - name: 'og:title'
      content: 'Canal 简介'
  ...
  - - meta
    - name: 'og:description'
      content: 'Canal基于MySQL主备复制原理解析增量日志，实现数据同步与订阅。其架构包括Event Parser（日志解析）、Event Sink（数据过滤转换）、Event Store（存储）、Instance（实例管理）、Server（服务端）及HA机制，支持高可用。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//ops/canal/index.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/ba2ac318ea04439c99735d4bada0ede2.png'
---
# Canal 简介

![](https://file.wulicode.com/feishu-images/ba2ac318ea04439c99735d4bada0ede2.png)
...
![](https://file.wulicode.com/feishu-images/8c24fc48a8b0f4013a27adfa3eedea21.jpg)
...
![](https://file.wulicode.com/feishu-images/3ba78bb0b0e04a86d4e0c7c262371568.png)
...
![](https://file.wulicode.com/feishu-images/9da2b5290ce92f9d9e1580212a94c90a.png)
...
![](https://file.wulicode.com/feishu-images/77de80dd8ae10e9c10bde334d3646170.png)
...
![](https://file.wulicode.com/feishu-images/62b59a1a249af83b38a833e9d087fd3b.png)
...
![](https://file.wulicode.com/feishu-images/820cb83b2c649ef46dce4d79d0525808.png)
...
![](https://file.wulicode.com/feishu-images/19567d277738f6ea57221681e98b0b34.png)
...
![](https://file.wulicode.com/feishu-images/b1da26d9abc68770af5c97ad839a832c.png)
...
![](https://file.wulicode.com/feishu-images/80463f74a1b050629915630979ce41af.png)

server代表了一个Canal运行实例，为了方便组件化使用，特意抽象了Embeded(嵌入式)/Netty(网络访问)的两种实现。

## 增量订阅/消费设计：

![](https://file.wulicode.com/feishu-images/22913092a0fbb1e82483205acbd353da.png)
...
针对上述的补充说明：1.可以提供数据库变更前和变更后的字段内容，针对binlog中没有的name、isKey等信息进行补全2.可以提供ddl的变更语句
...
![](https://file.wulicode.com/feishu-images/2284e7672e6647b02967e1600c51550c.jpg)
