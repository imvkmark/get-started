---
description: 'Canal快速入门：配置Java环境及Deployer，修改canal.properties开启实例扫描，配置instance.properties设置主库地址、账号密码及TSDB缓存。Adapter配置日志或ES7监听器，指定hosts、实例及ES映射。REST接口可查看实例、控制同步开关及触发全量同步。常见问题包括Java版本错误及ES连接异常。'
lastUpdated: '2026-07-02 12:22:26'
head:
  - - meta
    - name: 'og:title'
      content: 'Canal 快速入门'
  ...
  - - meta
    - name: 'og:description'
      content: 'Canal快速入门：配置Java环境及Deployer，修改canal.properties开启实例扫描，配置instance.properties设置主库地址、账号密码及TSDB缓存。Adapter配置日志或ES7监听器，指定hosts、实例及ES映射。REST接口可查看实例、控制同步开关及触发全量同步。常见问题包括Java版本错误及ES连接异常。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com/ops/canal/get-started.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/53b2851ec3c23ab60858bc7a408ba9ad.png'
---
# Canal 快速入门
...
- <cite doc-id="YRJEwCzaritn8jkMWmlc9majnWf" file-type="wiki" title="Client Adapter" type="doc"></cite>
- [Canal For ElasticSearch 适配器](/ops/canal/client-adapter-es.md)

本文主要描述一下功能

![](https://file.wulicode.com/feishu-images/53b2851ec3c23ab60858bc7a408ba9ad.png)
