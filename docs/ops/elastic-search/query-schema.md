---
description: 'Elasticsearch支持字符串、数值、日期、布尔、二进制、复杂类型及专用数据类型。查询方式包括match、term、range、wildcard等，支持全文搜索、短语匹配、多字段查询及过滤器。聚合提供sum、avg、terms、histogram等，可进行分组统计与嵌套聚合。具备搜索建议、自动补全和高亮功能。通过_cat查看索引、节点和分片信息，_cluster监控集群状态。支持SQL查询及转换分析。'
lastUpdated: '2026-07-02 12:17:26'
head:
  - - meta
    - name: 'og:title'
      content: 'ES 语法'
  ...
  - - meta
    - name: 'og:description'
      content: 'Elasticsearch支持字符串、数值、日期、布尔、二进制、复杂类型及专用数据类型。查询方式包括match、term、range、wildcard等，支持全文搜索、短语匹配、多字段查询及过滤器。聚合提供sum、avg、terms、histogram等，可进行分组统计与嵌套聚合。具备搜索建议、自动补全和高亮功能。通过_cat查看索引、节点和分片信息，_cluster监控集群状态。支持SQL查询及转换分析。'
  - - meta
    - name: 'og:url'
