---
description: 'nginx反向代理中proxy_pass的URL行为总结：仅指定host时保留原路径；包含路径时替换匹配前缀；正则匹配时支持重写。注意路径拼接、参数传递及未匹配情况。'
lastUpdated: '2026-06-18 08:00:03'
head:
  - - meta
    - name: 'og:title'
      content: 'proxy_pass url 反向代理'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: 'nginx反向代理中proxy_pass的URL行为总结：仅指定host时保留原路径；包含路径时替换匹配前缀；正则匹配时支持重写。注意路径拼接、参数传递及未匹配情况。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//ops/nginx/proxy-pass.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/ad72f2fc1d93e2e1b80111675a330130.png'
---
# proxy_pass url 反向代理
...
![](https://file.wulicode.com/feishu-images/ad72f2fc1d93e2e1b80111675a330130.png)
