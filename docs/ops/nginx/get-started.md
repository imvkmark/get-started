---
description: 'Nginx是一款高性能的Web服务器和反向代理服务器，以高并发、低内存占用著称。其知识体系包括配置文件、常见变量、常用工具及服务器、链接、客户端相关配置等内容，是后端开发与运维的重要工具。'
lastUpdated: '2026-06-18 08:33:36'
head:
  - - meta
    - name: 'og:title'
      content: 'Nginx 简介'
  ...
  - - meta
    - name: 'og:description'
      content: 'Nginx是一款高性能的Web服务器和反向代理服务器，以高并发、低内存占用著称。其知识体系包括配置文件、常见变量、常用工具及服务器、链接、客户端相关配置等内容，是后端开发与运维的重要工具。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//ops/nginx/get-started.html'
  - - meta
    - name: 'og:image'
      content: 'https://file.wulicode.com/feishu-images/1ffb956be3b494e9c84aa51782d6708d.png'
---
# Nginx 简介
...
![](https://file.wulicode.com/feishu-images/1ffb956be3b494e9c84aa51782d6708d.png)
