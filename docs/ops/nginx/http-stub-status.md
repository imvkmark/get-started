---
description: 'stub_status 功能用于提供访问基础状态信息，涵盖示例、声明、数据及嵌入变量等内容。'
lastUpdated: '2026-06-17 14:10:49'
head:
  - - meta
    - name: 'og:title'
      content: 'stub_status 提供访问基础状态信息'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: 'stub_status 功能用于提供访问基础状态信息，涵盖示例、声明、数据及嵌入变量等内容。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//ops/nginx/http-stub-status.html'
---
