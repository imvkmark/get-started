---
description: '在Nginx中强制URL小写，可通过安装nginx-extras（使用apt-get）后，利用Lua或Perl模块进行URL重写实现。'
lastUpdated: '2026-06-17 14:08:14'
head:
  - - meta
    - name: 'og:title'
      content: '强制使用小写的 url 地址'
  - - meta
    - name: 'og:type'
      content: 'article'
  - - meta
    - name: 'og:description'
      content: '在Nginx中强制URL小写，可通过安装nginx-extras（使用apt-get）后，利用Lua或Perl模块进行URL重写实现。'
  - - meta
    - name: 'og:url'
      content: 'https://www.wulicode.com//ops/nginx/force-lower-case-url.html'
---
# 强制使用小写的 url 地址
