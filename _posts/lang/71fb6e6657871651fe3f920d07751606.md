...
```
以上仅介绍了 easy_install 的一些常用的方法，想要了解更多，你可以点击官方文档：[setuptools.readthedocs.io](ce608ffd31174e9f7400864d3251beb0)
...
`classifiers` 参数说明包的分类信息。所有支持的分类列表见：[pypi.org/pypi?](https://link.zhihu.com/?target=https%3A//pypi.org/pypi%3F%253Aaction%3Dlist_classifiers)
...
## 8. 打包辅助神器PBR 是什么？
`pbr` 是 setuptools 的辅助工具，最初是为 OpenStack 开发([https://launchpad.net/pbr)，基于`d2to1`。](https://link.zhihu.com/?target=https%3A//launchpad.net/pbr%29%25EF%25BC%258C%25E5%259F%25BA%25E4%25BA%258E%2560d2to1%2560%25E3%2580%2582)
